const Quality = () => {
  return (
    <section className="quality-bg-img mt-[80px] md:mt-[224px] xxl:mt-[90px] px-[20px] pb-[40px] pt-[112px] rounded-(--radius-12) md:px-[82px] md:pb-[64px] md:pt-[140px] xxl:flex xxl:flex-row xxl:flex-row-reverse xxl:px-[80px] xxl:py-[112px] xxl:gap-[120px] xxl:items-center">
      ...
      <div className="flex flex-col gap-[32px] md:gap-[20px] xxl:gap-[32px]">
        <h2 className="text-preset-2-tablet text-(--neutral-50) xxl:text-preset-2 text-center xxl:text-start">
